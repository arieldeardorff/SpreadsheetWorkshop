...
???
To toggle presenter mode, first press c to clone the window, then press p to enter presenter mode (share the screen on the other window)
...
Make those variable names descriptive!
