...
* We recommend you use spreadsheets for data entry and data storage
* Once data has been collected it is time to move on to another tool for data analysis and visualization
* Data analysis in spreadsheets is messy, fraught with errors, and not easily reproduced
* Instead you should use an analysis software tool like R, Python, SAS, STATA, Tableau
...
[break these into separate pages with photo examples]
...
## Activity: Critique a messy data spreadsheet
